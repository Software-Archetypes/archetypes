...
import softwarearchetypes.MockedEventPublisherConfiguration;
import softwarearchetypes.TestDbConfiguration;
...
public class TakingRandomResourceTest {
    ...
    void canTakeRandomResourceFromPool() {
        ...
        //then
        Assertions.assertThat(taken1).hasValueSatisfying(resourcesPool::contains);
        ...
        //then
        Assertions.assertThat(taken2).hasValueSatisfying(resourcesPool::contains);
        ...
        //then
        Assertions.assertThat(taken3).hasValueSatisfying(resourcesPool::contains);
        ...
        //then
        Assertions.assertThat(taken4).isEmpty();
    }
    ...
    void nothingIsTakenWhenNoResourceInPool() {
        ...
        //then
        Assertions.assertThat(taken1).isEmpty();
    }
