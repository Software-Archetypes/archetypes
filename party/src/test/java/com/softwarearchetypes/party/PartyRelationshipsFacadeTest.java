...
class PartyRelationshipsFacadeTest {
    ...
    // private final PartyRelationshipsFacade facade = new PartyRelationshipsFacade(partyRoleFactory, partyRelationshipFactory, partyRelationshipRepository, partyRepository, eventsPublisher);
